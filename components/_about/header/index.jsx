...
export default function AboutHeader() {
  ...
  return (
    <header ref={ref} id="top" className="about-section-header relative w-screen h-screen flex-centered">
      ...
      <motion.h1 style={{ y: title }} id="about-title" className="about-title text-7xl mb-10 sm:mb-0 md:text-[10rem] uppercase font-black text-slate-900 tracking-wider" >About me</motion.h1>
