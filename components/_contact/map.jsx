...
export default function MapComponent() {
  ...
  return (
    <div className="contact-section-map flex-centered flex-col section-y-short section-x-default">
    <TextAnimationLetter
        className="title-primary-md flex justify-center"
        text={t(title)}
      />
      <div className="h-96 w-80 sm:w-[40rem] sm:h-[25rem] rounded-sm shadow-md overflow-hidden mt-6">
        <iframe
